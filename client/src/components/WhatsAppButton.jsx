  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative flex items-center gap-3 px-5 py-3.5 rounded-full bg-[#25D366] text-white shadow-xl hover:scale-105 transition-transform duration-300">
          ...
          <span className="hidden sm:inline font-medium text-sm">Book via WhatsApp</span>
        </div>
      </div>
    </a>
  );
